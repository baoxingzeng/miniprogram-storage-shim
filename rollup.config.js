...
export default [
    ...
    // CommonJS (singlefile)
    {
        input: "src/index.ts",
        output: {
            file: "dist/miniprogram-storage-shim.cjs.js",
            format: "cjs",
        },
        plugins: [
            typescript({
    ...
    // CommonJS (singlefile, minimized)
    {
        input: "src/index.ts",
        output: {
            file: "dist/miniprogram-storage-shim.cjs.min.js",
            format: "cjs",
        },
        plugins: [
            typescript({
    ...
    // ES6 (singlefile)
    {
        input: "src/index.ts",
        output: {
            file: "dist/miniprogram-storage-shim.esm.js",
            format: "es",
        },
        plugins: [
            typescript({
    ...
    // ES6 (singlefile, minimized)
    {
        input: "src/index.ts",
        output: {
            file: "dist/miniprogram-storage-shim.esm.min.js",
            format: "es",
        },
        plugins: [
            typescript({
